...
const Marketing = () => {
  return (
    <div className="-mt-48 w-10/12 mx-auto flex justify-center p-6 sm:p-8 md:p-10 bg-base-content border border-primary/30 shadow-[0_0_20px_rgba(0,255,255,0.2)] rounded-2xl">
