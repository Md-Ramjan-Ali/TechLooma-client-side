...
const ProductCard = ({ product, refetch }) => {
  ...
  return (
    <div className="backdrop-blur-md bg-base-content/60 border border-primary/30 shadow-[0_0_20px_rgba(0,255,255,0.2)] rounded-xl flex flex-col h-full">
      ...
      <div className="p-5 flex-grow flex flex-col space-y-6 text-secondary-content">
        ...
        <div className="flex flex-wrap gap-2 mb-3">
          {tags?.map((tag, i) => (
            <span
              key={i}
              className="px-3 py-1 bg-base-content/60 border border-primary/30 shadow-[0_0_20px_rgba(0,255,255,0.2)] rounded-xl text-xs font-medium text-secondary-content"
            >
              #{tag}
            </span>
          ))}
